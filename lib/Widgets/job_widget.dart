...
import 'package:sahada2_app/Jobs/job_details.dart';
              ...
              onPressed: () async{
                try{
                  if(widget.uploadedBy== _uid){
                    ...
                    GlobalMethod.showErrorDialog(error: "Bu işlemi gerçekleştiremezsiniz", ctx: ctx);

                  }
                }
                catch(error){
                  GlobalMethod.showErrorDialog(error: "Bu ilan silinemez", ctx: ctx);
                }
                finally{
