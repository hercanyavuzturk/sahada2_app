...
import 'package:sahada2_app/Widgets/comments_widget.dart';
...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
  ...
  void getJobData() async {
    ...
    if (jobDatabase == null) {
      ...
      setState(() {
        ...
        postedDate = jobDatabase.get('createdAt');
  ...
  applyForJob() {
    final Uri params = Uri(
      ...
      path: emailCompany,
      query:
          'subject=Applying for $jobTitle&body=Merhaba, ilana basvurmak istiyorum',
    );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            isDeadlineAvailable
                                ? 'Başvuru için açık, iletişim kurabilirsiniz.'
                                : 'İlanın süresi doldu.',
                            style: TextStyle(
                              ...
                              if(snapshot.connectionState == ConnectionState.waiting){
                              ...
                              else
                                {
                                  if(snapshot.data == null){
                                    const Center(child: Text('Yorum yazılmadı'),);
                                  }
                                }
